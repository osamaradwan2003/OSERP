...
class Attributes extends Secure_Controller
{
    ...
    public function getSearch(): ResponseInterface
    {
        ...
        $sort = $this->sanitizeSortColumn(attribute_definition_headers(), $params['sort'], 'definition_id');
        $order = $this->validateSortOrder($params['order']);

        $attributes = $this->attribute->search($params['search'], $params['limit'], $params['offset'], $sort, $order);
        $total_rows = $this->attribute->get_found_rows($params['search']);
