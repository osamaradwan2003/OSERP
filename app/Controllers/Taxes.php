...
class Taxes extends Secure_Controller
{
    ...
    public function getSearch(): ResponseInterface
    {
        ...
        $sort = $params['sort'] ?: 'tax_rate_id';
        $order = $this->validateSortOrder($params['order']);

        $tax_rates = $this->tax->search($params['search'], $params['limit'], $params['offset'], $sort, $order);

        $total_rows = $this->tax->get_found_rows($params['search']);
