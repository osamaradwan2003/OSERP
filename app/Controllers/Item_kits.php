...
class Item_kits extends Secure_Controller
{
    ...
    public function getSearch(): ResponseInterface
    {
        ...
        $sort = $this->sanitizeSortColumn(item_kit_headers(), $params['sort'], 'item_kit_id');
        $order = $this->validateSortOrder($params['order']);

        $item_kits = $this->item_kit->search($params['search'], $params['limit'], $params['offset'], $sort, $order);
        $total_rows = $this->item_kit->get_found_rows($params['search']);
