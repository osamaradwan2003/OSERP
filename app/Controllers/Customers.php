...
class Customers extends Persons
{
    ...
    public function getSearch(): ResponseInterface
    {
        ...
        $sort = $this->sanitizeSortColumn(customer_headers(), $params['sort'], 'people.person_id');
        ...
        $customers = $this->customer->search($params['search'], $params['limit'], $params['offset'], $sort, $order, false, $show_deleted);
        $total_rows = $this->customer->get_found_rows($params['search'], $show_deleted);
    ...
    public function getView(int $customer_id = NEW_ENTRY): string
    {
        ...
        $tax_code_info = $this->tax_code->get_info($info->sales_tax_code_id ?? null);
    ...
    public function postSave(int $customer_id = NEW_ENTRY): ResponseInterface
    {
        ...
        $person_data = [
            ...
            'email'        => empty($email) ? 'none@localhost' : $email,
    ...
    public function postRestore(): ResponseInterface
    {
        ...
        $builder = db_connect()->table('customers');
        $builder->whereIn('person_id', $ids);
