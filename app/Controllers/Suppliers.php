...
class Suppliers extends Persons
{
    ...
    public function getSearch(): ResponseInterface
    {
        ...
        $sort = $this->sanitizeSortColumn(supplier_headers(), $params['sort'], 'people.person_id');
        ...
        $suppliers = $this->supplier->search($params['search'], $params['limit'], $params['offset'], $sort, $order, false, $show_deleted);
        $total_rows = $this->supplier->get_found_rows($params['search'], $show_deleted);
    ...
    public function postRestore(): ResponseInterface
    {
        ...
        $builder = db_connect()->table('suppliers');
