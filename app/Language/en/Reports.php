...
return [
    ...
    "inventory_items_flow"                    => "Items Flow Detailed",
    "inventory_items_flow_report"             => "Items Flow Detailed Report",
    ...
    "cashflow_reports"                        => "Cashflow Reports",
    "cashflow_ledger"                         => "Cashflow Ledger",
    "cashflow_ledger_report"                  => "Cashflow Ledger Report",
    "cashflow_summary"                        => "Cashflow Summary",
    "cashflow_summary_report"                 => "Cashflow Summary Report",
    "cashflow_account_balance"                => "Cashflow Account Balance",
    "cashflow_account_balance_report"         => "Cashflow Account Balance Report",
    "financial_overview"                      => "Financial Overview",
    "financial_overview_report"               => "Financial Overview Report",
    "opening_balance"                         => "Opening Balance",
    "period_net"                              => "Period Net",
    "closing_balance"                         => "Closing Balance",
    "sales_net"                               => "Sales Net",
    "receivings_net"                          => "Receivings Net",
    ...
    "party_owes_store"                        => "Party owes store",
    "store_owes_party"                        => "Store owes party",
];
