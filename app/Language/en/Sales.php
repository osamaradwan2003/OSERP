...
return [
    ...
    "cashflow_account_required"        => "Please select a cashflow account for this payment.",
    "cashflow_no_active_accounts"      => "No active cashflow accounts found. Create/activate an account before adding payments.",
