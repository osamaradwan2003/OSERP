...
class Item_kit_items extends Model
{
    ...
    public function get_info(int $item_kit_id): array
    {
        ...
        $builder->select('item_kits.item_kit_id, item_kits.name, item_kit_items.item_id, quantity, kit_sequence, unit_price, item_type, stock_type');
...
//        $builder->groupBy('item_kit_items.item_kit_id');
