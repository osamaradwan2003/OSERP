        ...
        <div class="tab-pane fade in active" id="customer_basic_info">
            <fieldset>
                <div class="form-group form-group-sm">
                    ...
                    <div class="col-xs-1">
                        <?= form_checkbox('consent', 1, ($person_info->consent ?? '') == '' ? !$config['enforce_privacy'] : (bool)($person_info->consent ?? 0)) ?>
                    </div>
                </div>
                    ...
                    <div class="col-xs-8">
                        ...
                        <label class="radio-inline">
                            <?= form_radio([
                                ...
                                'id'      => 'discount_type',
                                'value'   => 1,
                                'checked' => ($person_info->discount_type ?? 0) == FIXED
                    ...
                    <div class="col-xs-3">
                        <div class="input-group input-group-sm">
                            <?= form_input([
                                ...
                                'onClick' => 'this.select();',
                                'value'   => ($person_info->discount_type ?? 0) === FIXED ? to_currency_no_money($person_info->discount ?? 0) : to_decimals($person_info->discount ?? 0)
                            ]) ?>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group form-group-sm">
                    ...
                    <div class="col-xs-1">
                        <?= form_checkbox('taxable', 1, ($person_info->taxable ?? 1) == 1) ?>
                    </div>
                </div>
