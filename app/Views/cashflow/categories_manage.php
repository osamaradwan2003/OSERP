...
<div class="cashflow-page">
    <div class="cashflow-breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="active"><?= lang('Cashflow.manage_categories') ?></li>
        </ol>
    </div>

    <div class="cashflow-page-header">
        <h1><span class="glyphicon glyphicon-tags" style="color: #667eea; margin-right: 10px;"></span><?= lang('Cashflow.manage_categories') ?></h1>
    </div>

    <div class="cashflow-toolbar-card">
        <div class="btn-toolbar">
            <div class="pull-right btn-group">
                <button class="btn btn-default btn-sm" onclick="window.location='<?= site_url('cashflow_category_types') ?>'">
                ...
                <button class="btn btn-info btn-sm modal-dlg" data-btn-submit="<?= lang('Common.submit') ?>" data-href="<?= site_url('cashflow_categories/view') ?>" title="<?= lang('Cashflow.new_category') ?>">
