...
<div id="title_bar" class="btn-toolbar">
    ...
    <button class="btn btn-info btn-sm pull-right modal-dlg" data-btn-submit="<?= lang('Common.submit') ?>" data-href="<?= site_url('cashflow_accounts/view') ?>" title="<?= lang('Cashflow.new_account') ?>">
