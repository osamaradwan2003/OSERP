...
<?= render_form_input('definition_name', 'Attributes.definition_name', $definition_info->definition_name, [
	'required' => true,
]) ?>

<?= render_form_dropdown('definition_type', 'Attributes.definition_type', DEFINITION_TYPES, array_search($definition_info->definition_type, DEFINITION_TYPES), [
	'required' => true,
]) ?>

<?= render_form_dropdown('definition_group', 'Attributes.definition_group', $definition_group, $definition_info->definition_fk, [
	'required' => false,
	'disabled' => empty($definition_group),
]) ?>
...
<?= render_form_input('definition_unit', 'Attributes.definition_unit', $definition_info->definition_unit, [
	'required' => false,
]) ?>
