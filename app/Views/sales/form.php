...
<?= form_open('sales/save/' . $sale_info['sale_id'], ['id' => 'sales_edit_form', 'class' => 'form-horizontal']) ?>
    <fieldset id="sale_basic_info">
        ...
        <div class="form-group form-group-sm">
            ...
            <div class="col-xs-8">
                <?= form_input(['name' => 'date', 'type' => 'datetime-local', 'class' => 'form-control input-sm', 'id' => 'date', 'value' => to_datetime(strtotime($sale_info['sale_time']))]) ?>
            </div>
        </div>
        ...
        <?php if ($balance_due) { ?>
            ...
            <div class="form-group form-group-sm">
                <?= form_label(lang('Cashflow.account'), 'cashflow_account_id_new', ['class' => 'control-label col-xs-3 required']) ?>
                <div class="col-xs-8">
                    <?= form_dropdown('cashflow_account_id_new', $cashflow_accounts, $default_cashflow_account_id, ['id' => 'cashflow_account_id_new', 'class' => 'form-control']) ?>
                </div>
            </div>
        <?php } ?>
        ...
        ?>
            ...
            <div class="form-group form-group-sm">
                <?= form_label(lang('Cashflow.account'), "cashflow_account_id_$i", ['class' => 'control-label col-xs-3 required']) ?>
                <div class="col-xs-8">
                    <?= form_dropdown("cashflow_account_id_$i", $cashflow_accounts, $row->cashflow_account_id ?? $default_cashflow_account_id, ['id' => "cashflow_account_id_$i", 'class' => 'form-control']) ?>
                </div>
            </div>
